    ...
    try {
        ...
        return NextResponse.json({
            ...
            data: {
                ...
                offlineCards: user.offlineCards || [],
                offlinePointsRate: user.offlinePointsRate || 0,
                highestLevelReached: user.highestLevelReached || 0,
                dailyEnergyRefills: user.dailyEnergyRefills || 0
            }
        });
